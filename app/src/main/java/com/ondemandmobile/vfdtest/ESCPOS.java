package com.ondemandmobile.vfdtest;
...
public class ESCPOS {
    ...
    public static final byte[] Left_Line= {0x0d};
    public static final byte[] Show_Time= {0x1F,0x55};         //start countdown.
    public static final byte[] Horiz_Scrol= {0x1F,0x03};
    public static final byte[] Anim= {0x1F,0x23,0x01};
    ...
    public static final byte[] BAR_CODE02 = {0x1D, 0x6B, 0x02};
    public static final byte[] VISOR_HIDE_CURSOR = {0x1F, 0x43, 0x00};
    public static final byte[] VISOR_SHOW_CURSOR = {0x1F, 0x43, 0x01};
    public static final byte[] VISOR_HOME = {0x0B};           //jump cursor to the first line left corner.
